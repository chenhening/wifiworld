...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	static final float FRICTION = 3.0f;//default 2.0
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if(a.hasValue(R.styleable.PullToRefresh_ptrFooterRefreshViewShow)){
			boolean show = a.getBoolean(R.styleable.PullToRefresh_ptrFooterRefreshViewShow, true);
			if(!show){
				setFooterViewNotShow();
			}
		}

		if(a.hasValue(R.styleable.PullToRefresh_ptrHeaderRefreshViewShow)){
			boolean show = a.getBoolean(R.styleable.PullToRefresh_ptrHeaderRefreshViewShow, true);
			if(!show){
...
//			mHeaderLayout.hideAllViews();
	...
	public void addHeaderPaddingTop(int addTop){
		if(mHeaderLayout != null){
			mHeaderLayout.setPaddingTop(addTop);
		}
	}
