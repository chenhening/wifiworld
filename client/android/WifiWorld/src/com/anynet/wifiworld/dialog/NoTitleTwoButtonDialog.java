...
/**
 * 基本的2Btn弹窗。默认左键取消，右键确定，默认无title
 * 
 * @author admin
 * 
 */
public class NoTitleTwoButtonDialog extends XLBaseDialog {
	public static final String TAG = "NoTitleTwoButtonDialog";
	...
	public NoTitleTwoButtonDialog(Context context) {
	...
	public void setLeftBtnListener(DialogInterface.OnClickListener lListener) {
		...
		mLeftBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				lListener.onClick(NoTitleTwoButtonDialog.this, 0);
			}
		});
	}
	...
	private void initUI() {
		View dlgView = LayoutInflater.from(mContext).inflate(R.layout.no_title_two_button_dialog, null);
