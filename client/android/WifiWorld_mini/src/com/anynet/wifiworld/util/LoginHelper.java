...
import com.anynet.wifiworld.util.DeviceUID;
...
public class LoginHelper {
	...
	public void updateWifiDynamic() {
		...
		if (WifiCurrent.getInstance(globalContext).getWifiListItem() == null)
			return;
		
		WifiDynamic record = new WifiDynamic();
		record.MacAddr = WifiCurrent.getInstance(globalContext).getWifiListItem().getWifiMac();
